...
const { StringSelectMenuBuilder, ActionRowBuilder, StringSelectMenuOptionBuilder, InteractionResponseFlags } = require('discord.js');
  ...
  async handle(interaction) {
    try {
      ...
      await interaction.reply({
        ...
        components: [row], // 1次元配列でOK
        flags: InteractionResponseFlags.Ephemeral, // ephemeral: true は非推奨
      });
    } catch (error) {
